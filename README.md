...
**Make sure default userid(1000) is a valid id with read/write permission on your system, if not change it on the docker-compose***REMOVED***yml**   
<br>Before you can start using this tool you might want to test locally with [docker-compose](https://docs***REMOVED***docker***REMOVED***com/compose/install/)***REMOVED***   
Simply run :
...
<br>When you activate a client the ssh pub key will be automatically added to the authorized_keys and unison will be able to sync using SSH***REMOVED***   
<br>Follow messages on the homepage to complete all the required steps***REMOVED***   
...
The default sync interval is 300s (5mins)***REMOVED***  I suggest to avoid a sync interval smaller than 60seconds***REMOVED***       
...
You can see details about an event id, basically you will see unison logs there***REMOVED***   
On the event page you can filter events by different criterias***REMOVED***    
<br>
<img src="***REMOVED***/docs/screenshots/events***REMOVED***jpg" />   
<br>
In order to keep sqlite database small events logs are purged with a daily scheduled task***REMOVED***   
