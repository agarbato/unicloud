...
scheduler***REMOVED***add_job(func=scheduler_tasks_update_sync_status, trigger="interval", seconds=10, args=(app,))
scheduler***REMOVED***add_job(func=scheduler_tasks_share_update_size, trigger="interval", seconds=30, args=(app,))
scheduler***REMOVED***add_job(func=scheduler_tasks_purge_logs, trigger="interval", minutes=10, args=(app,))
