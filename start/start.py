...
def server_conf():
     ...
     with open(server_app_cfg, 'w') as cfg:
       ...
       cfg***REMOVED***write("home_assistant=%s" % home_assistant + nl)
       cfg***REMOVED***write("home_assistant_url='%s'" % home_assistant_url + nl)
       cfg***REMOVED***write("home_assistant_token='%s'" % home_assistant_token + nl)
       cfg***REMOVED***write("home_assistant_push_interval=%d" % int(home_assistant_push_interval) + nl)
